...
<jsp:include page="header.jsp"></jsp:include>
    ...
    <div class="row jumbotron" style="margin:15px; padding:15px;align:center" >
        <div class="col-sm-12">					
            <div id="div" style="width:100%;height:16%;">
                ...
                <div class="div1" style="float:left"><h2>T</h2></div><br>    
            </div>								
        </div>	
    </div>  
    <p>Attampt all question.</p>
    <script type="text/javascript" src="autosubmit.js"></script>
    <div style="float: right"><span style="font-size: 20px;">Left</span>
        <h1 id="remain"></h1><span style="font-size: 20px;"></span>
    </div>
    <%
        try {
    ...
    %><form action="Exam.result.jsp" method="post"><%
        ...
        <div class="radio ">
            <label><input type="radio" value="Not Selected" name="<%= nameD%>"   checked>
                <b>No option selected</b></label>
        </div>
        <%
        %><hr><% nameD = "answer";
        ...
        %> <center>
            ...
            <button type="submit" class="btn btn-primary" style="width: 100px;" name="noq" id='btnauto' 
                    value="<%= i%>">Submit
            </button>
        </center>
    </form><%
