...
<html>
    ...
    <ul class="nav navbar-nav font5" style="float:right">
                    <li><a href="test.jsp" style="color:black">
                    <span class="glyphicon glyphicon-home">
                    </span> <b> Go to Dashboard</b></a>
                    </li>
    </ul><%
        }
    %>
    <%
        ...
        String[] nameA = new String[21];
          ...
          try {
              ...
              %><center><h3><table><td><% out.print("<b>" + "Name: " + "</b>" + fname + " " + lname + "<br>");%>
        ...
        %><h3><%
            ...
            %></h3><br></center><%                         String num = "" + number;
                 String mm = "" + n;;
                 String p = "" + per;
                 Date date = new Date();
